# -*- coding: utf-8 -*-
"""
Created on Sun Aug 19 18:12:19 2018
...
Se sim, simula uma operação de venda (Short Selling). Apresentando os valores finais.
"""
...
inicio = datetime.datetime(2018,8,1)
fim = datetime.datetime(2019,1,24)
...
def calcula_stop_loss(preco_actual, preco_inicial):
    ...
    tmp_stop_loss = float((preco_actual*3.6)/100)
...
def calculaOpcaoCompra(valor_escolhido,conta_inicial,soma_dias):
    ...
    #print('STOCK: ',valor_escolhido)    
    #print('Lista RSI: ', lista_rsi)
    ...
    #print('Valores : ', valores_restantes_total)
    ...
    while(i < len(valores_restantes_total)):
        ...
        if tenho_accoes == True and (stop_loss_valor < x):
                print ('--- Compra (atingiu Stop loss) --------',contador)
                tenho_accoes = False
                valor_da_compra = stop_loss_valor * total_de_accoes
                ...
                print('Accao preço compra  = ',round(x,2))
        ...
        #if rsi_actual>70 and rsi_actual<85 and rsi_anterior > rsi_actual:
        if rsi_actual>20 and rsi_actual<35 and rsi_anterior < rsi_actual:
        #if rsi_actual>20 and rsi_actual<35:     
        #if rsi_actual>20 and rsi_actual<35 and rsi_anterior > rsi_actual:    
        #if x > media_25 and media_25 > media_50 and rsi_actual>70:    
        #tenho_accoes = True
            preco_venda = x
            
            if n_venda == 0 and valor_da_conta != 0 and preco_venda > 5.0:
                tenho_accoes = True
                
                preco_venda_primeiro = preco_venda
                valor_da_conta = conta_inicial // 1
                total_de_accoes = valor_da_conta//x
                valor_da_conta = conta_inicial + valor_da_conta
                valor_da_venda = float(preco_venda_primeiro * total_de_accoes)
                stop_loss_valor = calcula_stop_loss(float(x), float(preco_venda_primeiro))
                stop_win_valor = calcula_stop_win(float(x), float(preco_venda_primeiro))
                n_venda = 1
                print('\n----------- VENDA N.1 ----------------',contador, 'Nome: ',valor_escolhido)
                #print('Data da Compra = ', dia_da_operacao)
                print('Valor por accao= ',round(preco_venda_primeiro,2))
                print('Valor MM25= ',round(media_25,2), ' -- MM50= ',round(media_50,2))
                print('Valor do RSI = ', rsi_actual)
                print('Total da venda = ',round(valor_da_venda,2))
                print('Total de accoes = ', total_de_accoes)
                print ('Valor do STOP LOSS = ',round(stop_loss_valor,2))
                print ('Valor do STOP WIN = ',round(stop_win_valor,2))
            """
            elif n_venda == 1 and valor_da_conta != 0 and preco_venda > (((preco_venda_primeiro*5.1)//100) + preco_venda_primeiro) :
                tenho_accoes = True
                preco_venda_segundo = preco_venda
                ...
                valor_da_venda2 = float(preco_venda_segundo * total_de_accoes2)
                valor_da_venda = valor_da_venda + valor_da_venda2
                preco_medio = valor_da_venda / total_de_accoes
                stop_loss_valor = calcula_stop_loss(float(preco_medio), float(preco_venda_segundo))
                n_venda = 2
                print('\n----------- VENDA N.2 ----------------',contador, 'Nome: ',valor_escolhido)
                #print('Data da Compra = ', dia_da_operacao)
                print('Valor por accao= ',round(preco_venda_segundo,2))
                print('Valor MM25= ',round(media_25,2), ' -- MM50= ',round(media_50,2))
                print('Valor do RSI = ', rsi_actual)
                ...
                print('Total de accoes = ', total_de_accoes)
                print ('Valor do STOP LOSS = ',round(stop_loss_valor,2))
            elif n_venda == 2 and valor_da_conta != 0 and preco_venda > (((preco_venda_segundo*5.1)//100) + preco_venda_segundo ):
                tenho_accoes = True
                preco_venda_terceiro = preco_venda
                valor_da_conta2 = valor_da_conta
                valor_da_conta = 0
                total_de_accoes3 = valor_da_conta2 // x
                total_de_accoes = total_de_accoes + total_de_accoes3
                valor_da_venda3 = float(preco_venda_terceiro * total_de_accoes3)
                valor_da_venda = valor_da_venda + valor_da_venda3
                preco_medio = valor_da_venda / total_de_accoes
                stop_loss_valor = calcula_stop_loss(float(preco_medio), float(preco_venda_terceiro))
                n_venda = 3
                print('\n----------- VENDA N.3 ----------------',contador, 'Nome: ',valor_escolhido)
                #print('Data da Compra = ', dia_da_operacao)
                print('Valor por accao= ',round(preco_venda_terceiro,2))
                print('Valor MM25= ',round(media_25,2), ' -- MM50= ',round(media_50,2))
                print('Valor do RSI = ', rsi_actual)
                print('Preco medio por accao= ',round(preco_medio,2))
                print('Total da venda = ',round(valor_da_venda,2))
        ...
        if tenho_accoes == True:
            ...
            #print('----------------------------------------------------')
            dias += 1
            stop_loss_valor_tmp = calcula_stop_loss(float(x), float(preco_venda))
